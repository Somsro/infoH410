...
\begin{abstract}
    ...
    Lastly, the DQN agent requires very long training sessions to reach a performance comparable to TD learning agent but offers the potential for more robust performance in complex scenarios.
