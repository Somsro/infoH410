...
\section{Experimentations}
    ...
    Fig:\ref{fig:dqn_training_metrics} over 16k episodes of training, and took around 10(?) hours to train on a GPU. %% TODO change this
    \begin{figure}[H]
        \centering
    ...
    \noindent Fig:\ref{fig:td_training_metrics} 50k episodes of training, and took over 2500s to train on a CPU.
    \begin{figure}[H]
        \centering
...
\section{Conclusion}
    %% TODO: Talk about expectimax slower but no training required, expecimax equivalent to n-tuple according to stats, DQN bad in every aspects (learning and testing)
