...
\author{
    ...
    Written by Denis Legue, Robin Marchand, Gabriel, Monwar Mahtab Hawlader (000514679) 
}
\affiliations{
    %Afiliations
    ULB\\
...
Three agents will be compared; Deep Q-Learning, Expectimax and an n-tuple network TD(0) learning agent.
...
\noindent \textbf{Approach: Expectimax} \\

\noindent \textbf{Approach: Deep Q-Learning (DQN)} \\
...
\noindent \textbf{Approach: N-tuple network TD(0) learning agent}\\
...
The value function is approximated using an N-tuple network composed of lookup tables defined over several tile patterns and their symmetric variants. 
